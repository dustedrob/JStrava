...
import org.jstrava.entities.segment.LeaderBoardEntry;
...
public class JStravaV3Test {
	...
	public void testCreateAndDeleteActivity() throws Exception {
		...
		Activity activityExtra = strava.createActivity("Test Manual Activity", "ride", "2014-03-14T09:00:00Z", 10,
				"Testing manual creation", 100);
