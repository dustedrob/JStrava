...
public interface JStrava {
	...
	public static final String ATHLETES_URL = "https://www.strava.com/api/v3/athletes";
	public static final String ATHLETE_FRIENDS_URL = ATHLETE_URL + "/friends";
	public static final String ATHLETE_FOLLOWERS_URL = ATHLETE_URL + "/followers";
	public static final String ATHLETE_ACTIVITIES_URL = ATHLETE_URL + "/activities";
	public static final String ATHLETE_CLUBS_URL = ATHLETE_URL + "/clubs";
	public static final String ACTIVITIES_URL = "https://www.strava.com/api/v3/activities";
	public static final String ACTIVITIES_FOLLOWING_URL = ACTIVITIES_URL + "/following";
	public static final String CLUBS_URL = "https://www.strava.com/api/v3/clubs";
	public static final String GEAR_URL = "https://www.strava.com/api/v3/gear";
	public static final String SEGMENTS_URL = "https://www.strava.com/api/v3/segments";
	public static final String SEGMENTS_EXPLORE_URL = SEGMENTS_URL + "/explore";
	public static final String SEGMENTS_STARRED_URL = SEGMENTS_URL + "/starred";
	public static final String SEGMENT_EFFORTS_URL = "https://www.strava.com/api/v3/segment_efforts";
	public static final String UPLOADS_URL = "https://www.strava.com/api/v3/uploads";
